...
<form id="agreementtable"  enctype="multipart/form-data" method="post" action="agreementprocess.php" name="FFFname" onsubmit="return Validate(this)">
	...
	<table class=" fstable table table-bordered">
		...
		<tr>
			<th>First Party <font style="color:#FF0000">*</font></th>
			<td>
			...
			<th>Second Party <font style="color:#FF0000">*</font></th>
			...
			<th>Organiser <font style="color:#FF0000">*</font></th>
		...
		<tr>
			<th>Agreement Date <font style="color:#FF0000">*</font></th>
			
			<td>
				<input class="form-control frminp" name="agreedate" id="agreedate" autocomplete="off" required>
			</td>
			<script>
			$('#agreedate').datepicker({format:'dd-mm-yyyy',}).on('change', function(){
				...
				agreefrom.setMonth( agreefrom.getMonth() + 8 );
			...
			<th>Period <font style="color:#FF0000">*</font></th>
			<td>
				<input class="form-control frminp" name="agreefrom" id="agreefrom" placeholder="From" style="width: 110px;float: left;" required>
				<script>
				...
				<input class="form-control frminp" name="agreeto" id="agreeto" placeholder="To" style="width: 110px;float: left;" required>
			</td>
			<th>PI / APM / TPM</th>
			<td style="width: 200px;">
		...
		<tr>
			<td colspan="8" >
				...
				<table class=" estable table table-bordered">
					<thead>
						<tr>
							<th rowspan="2" style="width:150px;">Crop <font style="color:#FF0000">*</font></th>
							<th rowspan="2">Production Code </th>
							<th rowspan="2" style="width:100px;">Type <font style="color:#FF0000">*</font></th>
							<th colspan="4">FS Code <font style="color:#FF0000">*</font></th>
						</tr>
						<tr>
					...
					<tbody id="farLandtbodya">
						<tr>
							...
							<td >
								<!-- <input> -->
								<select  id="ann_ophyb" name="ann_ophyb" class="form-control frminp" style="text-align:center; width:100%;" required>
									<option value="" selected disabled>Select</option>
									<option value="OP">OP</option>
									<option value="HYB">HYB</option>
								</select>
							</td>
							<td ><input id="fsfemale1" name="fsfemale1" maxlength="2" autocomplete="off" onKeyPress="return (event.charCode > 64 && 
event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" onkeyup="copytomale(this.value)" style="text-align:center;" required></td>
							<td ><input id="fsfemale2" name="fsfemale2" maxlength="3" autocomplete="off" style="text-align:center;" required></td>
							<td ><input id="fsmale1" name="fsmale1"  maxlength="2" class="alphabetOnly" onKeyPress="return (event.charCode > 64 && 
event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" onkeyup="this.value = this.value.toUpperCase();" style="text-align:center;" required></td>
...
<br><br><br>
						                        ...
						                        <input type="hidden" name="ann3_additional_fee" style="text-align:center;" onKeyPress="return isNumberFKey(event)">
												<input type="hidden" name="ann4_cult_area" id="ann4_cult_area" style="text-align:center;" onKeyPress="return isNumberFKey(event)">
											
												<input type="hidden" name="ann4_cult_cost" id="ann4_cult_cost" style="text-align:center;" onKeyPress="return isNumberFKey(event)">
												
												<input type="hidden" name="ann4_estiyield_rawqty" id="ann4_estiyield_rawqty" style="text-align:center;" onKeyPress="return isNumberFKey(event)">
												<input type="hidden" name="ann4a_loss_ofyield" style="text-align:center;" onKeyPress="return isNumberFKey(event)">
						<?php /*
