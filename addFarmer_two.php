...
<form id="farmertable"  enctype="multipart/form-data" method="post" action="mastersAjax.php">
	...
	<table class=" fstable table table-bordered" border="0">
		...
		<tr>
			...
			<td>
				<input class="form-control frminp" name="fname" required>
			</td>
		...
		<tr>
			...
			<td>
				<input class="form-control frminp" name="father_name" required>
			</td>
		...
		<tr>
			...
			<td>
				<input class="form-control frminp" name="bank_name" required>
			</td>
			...
			<th>Branch Name</th>
			<td>
				<input class="form-control frminp" name="branch_name" >
			</td>
		...
		<tr>
			...
			<th>Bank Address</th>
			<td>
				<input class="form-control frminp" name="bank_add" >
			</td>
		...
		<tr>
			<th>Address</th>
			<td>
				<input class="form-control frminp" name="address" >
			</td>
			<th>
				State
