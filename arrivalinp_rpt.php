...
<script>
	...
	function agreeSearch(page){
		...
		/*
		$.post("arrivalinp_act.php",{ act:'get_agr_report_ArrRpt',page:page,crop:crop,orgr:orgr,from:from,to:to,secondparty:secondparty,users:users,keywordSearch:keywordSearch,prodcode:prodcode,pperson:pperson,pexe:pexe,sii:sii,dii:dii,tii:tii,vii:vii,driv:driv},function(data) {
