		...
		<tr>
			...
			<td style="width: 200px;">
				...
				<select class="form-control frminp" name="pexecutive" id="pexecutive">
					...
					<option value="<?=$key?>" <?=($agrd['prod_executive']==$key)?'selected':'';?>  ><?=$value?></option>
					<?php } ?>
				</select>
			</td>
					...
					<tbody id="farLandtbodya">
						<tr>
							...
							<td >
							    ...
							    <input type="hidden" id="prdcd" value="<?=$agrd['ann_prodcode'];?>" />
								...
								<script type="text/javascript">
									function getAllCropDetails(){ 
										...
										if(cid!=null){  
										  	...
										  	$.post("mastersAjax_agri.php",{ act:'get_production_code',cid:cid,prdcd:prdcd  },function(data) { 
							...
							<td ><input id="ann_ophyb" name="ann_ophyb"  style="text-align:center; width:100%;"></td>
							<td ><input id="fsfemale1" name="fsfemale1" value="<?=substr($agrd['ann_fscode_f'], 0, 2);?>" style="text-align:center;"></td>
							<td ><input id="fsfemale2" name="fsfemale2" value="<?=substr($agrd['ann_fscode_f'], 2, 4);?>" style="text-align:center;"></td>
							<td ><input id="fsmale1" name="fsmale1" value="<?=substr($agrd['ann_fscode_m'], 0, 2);?>" style="text-align:center;"></td>
							<td ><input id="fsmale2" name="fsmale2" value="<?=substr($agrd['ann_fscode_m'], 2, 4);?>" style="text-align:center;"></td>
								...
								<table class="antable">
									...
									<tbody>
										<tr style="height:28px;">
											...
											<td>
												<input type="" name="ann3_additional_fee" style="text-align:center;" onKeyPress="return isNumberFKey(event)" value="<?=$agrd['ann3_additional_fee']?>">
											</td>
										</tr>
									</tbody>
								</table>
							...
							<td colspan="20">
								...
								<table class="antable">
									...
									<tbody>
										<tr>
											<td>
											 <select name="ann7_areain_acre" id="ann7_areain_acre" style="width:100%;height:100%;">                                       <?php
